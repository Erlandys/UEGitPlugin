...
public:
	 ...
	 */
	virtual bool Execute( class FGitLFSSourceControlCommand& InCommand ) = 0;
...
typedef TSharedRef<IGitLFSSourceControlWorker, ESPMode::ThreadSafe> FGitSourceControlWorkerRef;
