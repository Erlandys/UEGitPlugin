 ...
 */
bool CheckGitAvailability(const FString& InPathToGitBinary, FGitLFSVersion* OutVersion = nullptr);
 ...
 */
 void ParseGitVersion(const FString& InVersionString, FGitLFSVersion* OutVersion);
	...
	/**
		...
		* @param OutGitVersion			If provided, populate with the git version parsed from "version" command
		*/
	void FindGitCapabilities(const FString& InPathToGitBinary, FGitLFSVersion* OutVersion);
	...
	/**
		...
		* @param OutGitVersion			If provided, populate with the git version parsed from "version" command
		*/
	void FindGitLfsCapabilities(const FString& InPathToGitBinary, FGitLFSVersion* OutVersion);
 ...
 * @returns true if any states were updated
 */
bool CollectNewStates(const TArray<FString>& InFiles, TMap<const FString, FGitLFSState>& OutResults, EGitLFSFileState::Type FileState, EGitLFSTreeState::Type TreeState = EGitLFSTreeState::Unset, EGitLFSLockState::Type LockState = EGitLFSLockState::Unset, EGitLFSRemoteState::Type RemoteState = EGitLFSRemoteState::Unset);
