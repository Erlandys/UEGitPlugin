...
2. Implement FGitLFSSourceControlProvider::bWorkingOffline like the SubversionSourceControl plugin
...
public:
	...
	FGitLFSSourceControlSettings& AccessSettings()
	{
		return GitSourceControlSettings;
	}

	const FGitLFSSourceControlSettings& AccessSettings() const
	{
		return GitSourceControlSettings;
	}
	...
	FGitLFSSourceControlProvider& GetProvider()
	{
		return GitSourceControlProvider;
	}

	const FGitLFSSourceControlProvider& GetProvider() const
	{
		return GitSourceControlProvider;
	}
	 ...
	 */
	static inline FGitLFSSourceControlModule& Get()
	{
		return FModuleManager::Get().LoadModuleChecked< FGitLFSSourceControlModule >("GitLFSSourceControl");
	}

	static inline FGitLFSSourceControlModule* GetThreadSafe()
	{
...
private:
	...
	FGitLFSSourceControlProvider GitSourceControlProvider;
