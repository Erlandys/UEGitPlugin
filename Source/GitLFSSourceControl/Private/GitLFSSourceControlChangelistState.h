...
{
public:
	explicit FGitLFSSourceControlChangelistState(const FGitLFSSourceControlChangelist& InChangelist,
	...
	explicit FGitLFSSourceControlChangelistState(FGitLFSSourceControlChangelist&& InChangelist,
